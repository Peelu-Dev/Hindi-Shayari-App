...
import com.peelu.merishayari.adapter.CategoryAdaptor
import com.peelu.merishayari.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        db.collection("Shayari").addSnapshotListener{ value,_ ->
